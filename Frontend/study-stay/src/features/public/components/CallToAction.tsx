...
export default function CallToAction() {
    return (
        <section className="py-16 lg:py-24 px-4 lg:px-8">
            <div className="max-w-7xl mx-auto bg-primary rounded-[2rem] p-8 lg:p-24 text-center text-white relative overflow-hidden">
                ...
                <div className="relative z-10">
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
                        ...
                        <button className="w-full sm:w-auto px-10 py-5 bg-primary-container border border-primary-fixed-dim/30 text-white rounded-xl font-bold text-lg hover:bg-primary-container/80 transition-all">
                            احجز جولة
                        </button>
                    </div>
                    <p className="mt-8 text-indigo-200 text-sm">
                        أكثر من 20,000 طالب يستخدمون StudyStay في 15 دولة.
                    </p>
                </div>
            </div>
        </section>
